...
module.exports.config = {
    name: "addrole",
    description: "**Secret Command**: Adds a role to a member of the guild!\n" +
        "**The Bot**: Needs **Administrator** and **Manage Roles** Permission\n" +
        "**The User Using the Command**: Needs the **Administrator** and **Manage Roles** Permission",
    usage: "!addrole",
